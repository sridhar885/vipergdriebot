...
class Config:
  ...
  if ENV:
    ...
    BOT_TOKEN = '5499480279:AAGappdjMocIxBkwmtTKsYSxRAlaCh30oJw' # Get it from https://t.me/BotFather
    APP_ID = '19220133' # Get it from my.telegram.org/apps
    API_HASH = 'df11ebf82e2fb0d0465c2f903ec67e66' # Get it from my.telegram.org/apps
    DATABASE_URL = 'postgres://ghtakfli:RDN2VKaLVLk-fczSG5yE519zZR-jgJn2@john.db.elephantsql.com/ghtakfli' # SQL Database URL / Heroku Postgres URL
